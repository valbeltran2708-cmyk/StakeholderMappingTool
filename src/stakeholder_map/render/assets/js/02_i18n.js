...
filters:'Filtros',key_actors:'Actores clave',
  ...
  ego_title:'Conexiones directas',tip_closeright:'Cierra el panel y le da todo el ancho al mapa.',panel_title:'Detalle del actor',d_select:'Selecciona un stakeholder',d_select_txt:'Click en un nodo para resaltar sus conexiones. Si es una entidad con subdivisiones, se abre su mapa local.',
  m_title:'Imagen para reporte',mt_content:'Contenido',mt_labels:'Etiquetas',mt_colors:'Colores',mt_legend:'Leyenda',mt_foot:'Pie',m_preview:'Previsualizaci\u00f3n',m_extra:'Extras',m_showkey:'Incluir nota de lectura',m_showtitle:'Mostrar t\u00edtulo',m_showsub:'Mostrar subt\u00edtulo',m_idx_gap:'Espaciado entre columnas',tip_showtitle:'Muestra u oculta el t\u00edtulo en la figura.',tip_showsub:'Muestra u oculta el subt\u00edtulo en la figura.',tip_showkey:'A\u00f1ade al pie una l\u00ednea que explica c\u00f3mo leer la figura.',tip_legfont:'Escala toda la leyenda: nombres, encabezados (esferas, dimensiones, relaciones) e \u00edndice.',tip_idxgap:'Separaci\u00f3n horizontal entre las columnas del \u00edndice.',m_sub:'Exporta lo visible en el mapa. Los filtros de actores se controlan en el panel izquierdo.',
...
filters:'Filters',key_actors:'Key actors',
  ...
  ego_title:'Direct connections',tip_closeright:'Close the panel and give the map full width.',panel_title:'Actor detail',d_select:'Select a stakeholder',d_select_txt:'Click a node to highlight its connections. If it is an entity with subdivisions, its local map opens.',
  m_title:'Image for report',mt_content:'Content',mt_labels:'Labels',mt_colors:'Colors',mt_legend:'Legend',mt_foot:'Caption',m_preview:'Preview',m_extra:'Extras',m_showkey:'Include reading note',m_showtitle:'Show title',m_showsub:'Show subtitle',m_idx_gap:'Column spacing',tip_showtitle:'Show or hide the title in the figure.',tip_showsub:'Show or hide the subtitle in the figure.',tip_showkey:'Adds a caption line explaining how to read the figure.',tip_legfont:'Scales the whole legend: names, headers (spheres, dimensions, relationships) and index.',tip_idxgap:'Horizontal spacing between index columns.',m_sub:'Exports what is visible on the map. Actor filters are controlled in the left panel.',
