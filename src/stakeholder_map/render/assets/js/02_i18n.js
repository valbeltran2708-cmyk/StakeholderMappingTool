var LANG={
 es:{
  ...
  tip_kmode:'Ordena la lista por inter\u00e9s + poder o por n\u00famero de conexiones.',tip_topn:'Cu\u00e1ntos actores mostrar en la lista.',tip_isolate:'Deja en el mapa solo los actores clave de la lista.',tip_sphere:'Filtra los actores por esfera.',tip_reltype:'Filtra las relaciones por tipo.',tip_imp:'Filtra por nivel de importancia en el proyecto.',tip_spread:'Separa o junta los anillos de inter\u00e9s para dar aire al mapa.',tip_search:'Busca un actor por nombre o sigla y lo resalta.',tip_zin:'Acercar.',tip_zout:'Alejar.',tip_zfit:'Encajar todo el mapa en la vista.',tip_bdetail:'Muestra u oculta el panel de detalle del actor.',tip_blegend:'Muestra una leyenda flotante sobre el mapa.',tip_bexport:'Abre el di\u00e1logo para exportar la figura.',tip_csv_str:'Descarga la tabla de estrategia (zona Mendelow y acci\u00f3n por actor).',tip_csv_nodes:'Descarga la tabla de actores con sus atributos.',tip_csv_edges:'Descarga la tabla de relaciones.',tip_qzone:'Colorea todas las celdas de una zona de Mendelow a la vez.',tip_qcell:'Colorea cada celda inter\u00e9s\u00d7poder por separado.',tip_legrow:'Clic para filtrar el mapa por este elemento.',tip_m_labels:'Qu\u00e9 se escribe dentro de cada c\u00edrculo.',tip_m_color:'Figura a color o en escala de grises.',tip_m_bg:'Fondo blanco o transparente.',tip_m_legend:'Qu\u00e9 leyendas acompa\u00f1an la figura.',tip_m_legpos:'D\u00f3nde va la leyenda respecto a la figura.',tip_m_res:'Nitidez del PNG: 2x pantalla, 3x impresi\u00f3n.',tip_m_font:'Tipograf\u00eda de todos los textos de la figura.',tip_m_reltypes:'Qu\u00e9 tipos de relaci\u00f3n se dibujan en la imagen.',tip_m_idx:'Qu\u00e9 muestra cada entrada del \u00edndice de convenciones.',
filters:'Filtros',key_actors:'Actores clave',
  ...
  ego_title:'Conexiones directas',tip_closeright:'Cierra el panel y le da todo el ancho al mapa.',tip_foot:'Agrega un pie de figura (n\u00famero y fuente) debajo de la imagen.',m_num_uniform:'N\u00fameros del mismo tama\u00f1o',node_shape:'Forma de los nodos',shape_circle:'C\u00edrculo',shape_rect:'Rect\u00e1ngulo',tip_shape:'Dibuja los nodos como c\u00edrculos o como rect\u00e1ngulos de esquinas redondeadas (\u00fatil en la vista de cuadrante). Aplica tambi\u00e9n al exportar.',tip_num_uniform:'Todos los n\u00fameros dentro de los c\u00edrculos con el mismo tama\u00f1o (el que indiques). Si lo apagas, cada n\u00famero se ajusta al tama\u00f1o de su c\u00edrculo.',tip_footdate:'Incluye la fecha en el pie de figura.',panel_title:'Detalle del actor',d_select:'Selecciona un stakeholder',d_select_txt:'Click en un nodo para resaltar sus conexiones. Si es una entidad con subdivisiones, se abre su mapa local.',
  m_title:'Imagen para reporte',mt_content:'Contenido',mt_labels:'Etiquetas',mt_colors:'Colores',mt_legend:'Leyenda',mt_foot:'Pie',m_preview:'Previsualizaci\u00f3n',m_extra:'Extras',m_showkey:'Incluir nota de lectura',m_showtitle:'Mostrar t\u00edtulo',m_showsub:'Mostrar subt\u00edtulo',m_idx_gap:'Espaciado columnas (actores)',m_entry_gap:'Espaciado columnas (esferas/dim.)',tip_entrygap:'Separaci\u00f3n entre columnas de la leyenda de esferas, dimensiones y relaciones.',tip_showtitle:'Muestra u oculta el t\u00edtulo en la figura.',tip_showsub:'Muestra u oculta el subt\u00edtulo en la figura.',tip_showkey:'A\u00f1ade al pie una l\u00ednea que explica c\u00f3mo leer la figura.',tip_legfont:'Escala toda la leyenda: nombres, encabezados (esferas, dimensiones, relaciones) e \u00edndice.',tip_idxgap:'Separaci\u00f3n entre columnas del \u00edndice de actores (convenciones). Admite negativos para juntarlas.',m_sub:'Exporta lo visible en el mapa. Los filtros de actores se controlan en el panel izquierdo.',
  ...
  m_idx_cols:'Columnas del \u00edndice',m_idx_font:'Tama\u00f1o de letra de la leyenda',m_auto:'Autom\u00e1tico',
 ...
 en:{
  ...
  tip_kmode:'Ranks the list by interest + power or by number of connections.',tip_topn:'How many actors to show in the list.',tip_isolate:'Show only the key actors from the list on the map.',tip_sphere:'Filter actors by sphere.',tip_reltype:'Filter relationships by type.',tip_imp:'Filter by importance level in the project.',tip_spread:'Spread or tighten the interest rings to give the map room.',tip_search:'Search an actor by name or acronym and highlight it.',tip_zin:'Zoom in.',tip_zout:'Zoom out.',tip_zfit:'Fit the whole map in view.',tip_bdetail:'Show or hide the actor detail panel.',tip_blegend:'Show a floating legend over the map.',tip_bexport:'Open the dialog to export the figure.',tip_csv_str:'Download the strategy table (Mendelow zone and action per actor).',tip_csv_nodes:'Download the actors table with their attributes.',tip_csv_edges:'Download the relationships table.',tip_qzone:'Color all cells of a Mendelow zone at once.',tip_qcell:'Color each interest\u00d7power cell separately.',tip_legrow:'Click to filter the map by this item.',tip_m_labels:'What is written inside each circle.',tip_m_color:'Figure in color or grayscale.',tip_m_bg:'White or transparent background.',tip_m_legend:'Which legends accompany the figure.',tip_m_legpos:'Where the legend sits relative to the figure.',tip_m_res:'PNG sharpness: 2x screen, 3x print.',tip_m_font:'Typeface for all figure text.',tip_m_reltypes:'Which relationship types are drawn in the image.',tip_m_idx:'What each entry of the conventions index shows.',
filters:'Filters',key_actors:'Key actors',
  ...
  ego_title:'Direct connections',tip_closeright:'Close the panel and give the map full width.',tip_foot:'Adds a figure caption (number and source) below the image.',m_num_uniform:'Same-size numbers',node_shape:'Node shape',shape_circle:'Circle',shape_rect:'Rectangle',tip_shape:'Draw nodes as circles or as rounded rectangles (handy in the quadrant view). Applies to the export too.',tip_num_uniform:'All numbers inside the circles at the same size (the one you set). Turn it off to fit each number to its circle.',tip_footdate:'Includes the date in the figure caption.',panel_title:'Actor detail',d_select:'Select a stakeholder',d_select_txt:'Click a node to highlight its connections. If it is an entity with subdivisions, its local map opens.',
  m_title:'Image for report',mt_content:'Content',mt_labels:'Labels',mt_colors:'Colors',mt_legend:'Legend',mt_foot:'Caption',m_preview:'Preview',m_extra:'Extras',m_showkey:'Include reading note',m_showtitle:'Show title',m_showsub:'Show subtitle',m_idx_gap:'Column spacing (actors)',m_entry_gap:'Column spacing (spheres/dims.)',tip_entrygap:'Spacing between columns of the spheres, dimensions and relationships legend.',tip_showtitle:'Show or hide the title in the figure.',tip_showsub:'Show or hide the subtitle in the figure.',tip_showkey:'Adds a caption line explaining how to read the figure.',tip_legfont:'Scales the whole legend: names, headers (spheres, dimensions, relationships) and index.',tip_idxgap:'Spacing between columns of the actors index (conventions). Accepts negatives to pack them.',m_sub:'Exports what is visible on the map. Actor filters are controlled in the left panel.',
  ...
  m_idx_cols:'Index columns',m_idx_font:'Legend text size',m_auto:'Automatic',
