...
def write_tables(nodes, edges, outdir, prefix=''):
    xlsx = outdir / f'{prefix}stakeholder_map_coordinates.xlsx'
    ...
    csv_n = outdir / f'{prefix}stakeholder_nodes_coordinates.csv'
    csv_e = outdir / f'{prefix}stakeholder_edges.csv'
